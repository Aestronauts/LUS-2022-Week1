...
public class AfterImage : MonoBehaviour
{
    ...
    private Transform objPoolParent;
    ...
    void Start()
    {
        ...
        //parent holder
        objPoolParent = new GameObject("Character Clone Pool Parent").transform;
        ...
        for (int i = 0; i < poolSize; i++)
        {
            ...
            obj.SetActive(false);
            objectPool.Add(obj);
            obj.transform.parent = objPoolParent;
        }
    }
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("space")) { CreateAfterImage(); }
    ...
    public void CreateAfterImage()
    {
        ...
        //StartCoroutine(DisableClone(obj.Item1)); //*****THIS TURNS THE CLONE OFF
